package com.kawunus.habityou.usefulhabits.presentation.ui
...
fun HabitToggleButton(
    ...
    val icon = if (!checkedSecondary && !checked) Icons.Default.Close else Icons.Default.Done

    AnimatedContent(
        targetState = Pair(checked, icon),
        label = "HabitToggleButton"
    ) {
